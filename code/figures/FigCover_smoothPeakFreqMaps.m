...
smoothFileOut = fullfile(savePath,['AvgSubject_comboZpeakFreq.dtseries_smooth.dtseries.nii']);
workbenchPath = getpref('mriSinaiAnalysis','wbCommand');
leftSurface = '/Users/aguirre/Desktop/CIFTI_anatomy/L.inflated.32k_fs_LR.surf.gii';
rightSurface = '/Users/aguirre/Desktop/CIFTI_anatomy/R.inflated.32k_fs_LR.surf.gii';
smoothCifti = [workbenchPath ' ' '-cifti-smoothing' ' ' fileOut  ' 1 1'  ' ' 'COLUMN' ' ' smoothFileOut ' ' '-left-surface' ' ' leftSurface ' ' '-right-surface' ' ' rightSurface]; % ' ' '-fix-zeros-surface' ' '];
system(smoothCifti);
