...
% Set the p0
p0 = [Q 22 1.1 1.2 09 0.5 10 30 0.7 1.4];
...
for ss = 2:length(subjectNames)
    ...
    for cc = 1:nChunks
        ...
        parfor gg = 1:subChunk
            ...
            % populations; we optionally give these weights a bit of extra
            % oomph here to encourage a good match to the data. Currently
            % not implemented.
            W(1,:,:) = W(1,:,:)*1;
