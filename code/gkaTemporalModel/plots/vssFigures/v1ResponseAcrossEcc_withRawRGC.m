...
for whichSub = 1:length(subjects)
    ...
    for whichStim = 1:nStims
        ...
        for ee=1:nEccs
            ...
            % select the correct stimulus directino plot
            ...
            % Add the model fit
            plot(log10(freqsForPlotting),squeeze(v1YFitMatrix(whichStim,ee,:))-shift_ttf(ee),'-','Color',lineColor{stimOrder(whichStim)});
