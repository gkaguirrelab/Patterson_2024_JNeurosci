function [chromaticCenterWeight,chromaticSurroundWeight] = returnChromaticWeights(eccentricityDeg,LMratio)
...
chromaticCenterWeight = cpL - cpM;
chromaticSurroundWeight = spL - spM;
