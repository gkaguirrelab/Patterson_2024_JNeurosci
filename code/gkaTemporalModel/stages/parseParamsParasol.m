%% parseParamsParasol
function [rfParasolLum, rfLMCone, rfParasolBipolar, f] = parseParamsParasol(pBlock, cfCone, coneDelay)
...
[rfLMCone, rfParasolBipolar, rfParasolLum, f] = assembleParasolRFs(...
    cfCone, coneDelay, ...
